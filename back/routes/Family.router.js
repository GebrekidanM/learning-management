...
//register family
router.post('/family', upload.single('familyPhoto'),onlyForAdmin, CreateFamily)
//get all families
router.get('/families',AllFamilies)
//update family
router.patch('/family/update/:familyId', upload.single('familyPhoto'),onlyForAdmin,UpdateFamily);
